...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.45\linewidth]{missing_values_heatmap.png}
    \includegraphics[width=0.45\linewidth]{outlier_boxplot.png}
    \caption{Missing Values and Outlier Detection}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\linewidth, height=10cm]{wind_gust_direction.png}
    \caption{Wind Gust Direction}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\linewidth, height=5cm]{rainfall_dist_month.png}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.45\linewidth]{sunshine_vs_rainfall.png}
    \includegraphics[width=0.45\linewidth]{wind_vs_rainfall.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.45\linewidth]{rainfall_vs_temp.png}
    \includegraphics[width=0.45\linewidth]{rainfall_location.png}
    \caption{Rainfall vs Temp and Rainfall vs Location Distribution}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.45\linewidth]{avg_rainfall.png}
    \includegraphics[width=0.45\linewidth]{mintemp_maxtemp.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{placeholder_corr.png}
    \caption{Correlation Heatmap of Numeric Features}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth, height=9cm]{highly_corr.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\linewidth]{histograms_numeric.png}
    \caption{Histograms of Key Features}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{pairplot_features.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\linewidth, height=7cm]{km_pca.png}
...
\begin{figure}[H]
    \includegraphics[width=0.55\linewidth, height=7cm]{matrix_lowrank.png}
    \includegraphics[width=0.45\linewidth, height=7cm]{Difference_matrix.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\linewidth]{decisionregion_pca.png}
    \caption{Decision Region for PCA Models}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\linewidth]{decisionregion_svd.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\linewidth]{placeholder_accuracy_f1.png}
    \caption{Model Comparison: Accuracy and F1-Score}

    \includegraphics[width=0.6\linewidth]{placeholder_auc_cohen.png}
